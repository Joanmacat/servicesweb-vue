<template>
  ...
  <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div
      class="mt-12 grid sm:grid-cols-2 lg:grid-cols-2 items-center gap-4 lg:gap-8"
    >
      <!-- Icon Block -->
      <a
      ...
      >
        <svg
          class="w-9 h-9 text-gray-800 mx-auto dark:text-gray-200"
      ...
      >
        ...
        <div class="grow">
          ...
          <p class="mt-1 text-gray-500">
            Search our ABOUT for answers to anything you might ask.
          </p>
          <p
            class="mt-5 inline-flex items-center gap-x-2 font-medium text-blue-600 dark:text-blue-500"
          >
